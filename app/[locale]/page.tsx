    ...
    <div className="hero-content text-center">
     <div className="max-w-4xl">
      ...
      <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
       Build features your users actually want. Create beautiful feature request
       boards, gather feedback, and prioritize based on real user demand.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
       <div className="card bg-white shadow-sm">
        <div className="card-body items-center text-center">
         ...
         <p className="text-sm text-gray-600">
          Create your feedback board in minutes with our intuitive interface
         </p>
        </div>
       </div>
       ...
       <div className="card bg-white shadow-sm">
        <div className="card-body items-center text-center">
         ...
         <p className="text-sm text-gray-600">
          Let users vote on features to help you prioritize development
         </p>
        </div>
       </div>
    ...
    <div className="container mx-auto px-4">
     <div className="text-center mb-16">
      ...
      <p className="text-xl text-gray-600 max-w-2xl mx-auto">
       Our platform provides all the tools you need to gather, organize, and act
       on user feedback.
      </p>
     </div>
     ...
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      <div>
       ...
       <p className="text-gray-600 mb-6">
        Create beautiful, public-facing boards where your users can submit
        feature requests, vote on existing ones, and engage in discussions about
        what matters most.
       </p>
