      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-base-content/70 mt-2">
            Set up a new feedback board to start collecting feature requests from your users.
          </p>
        </div>
          ...
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-control mb-4">
                ...
                <label className="label">
                  <span className="label-text-alt">
                    Optional: Help users understand what kind of feedback you&apos;re looking for
                  </span>
                </label>
              </div>
              ...
              <div className="form-control mb-4">
                ...
                <div className="join w-full">
                  <span className="join-item bg-base-200 flex items-center px-3 text-sm text-base-content/70">
                    insights.app/b/
                  </span>
                  <input
                    type="text"
                ...
                <label className="label">
                  <span className="label-text-alt">
                    This will be your board&apos;s public URL. Only lowercase letters, numbers, and hyphens allowed.
                  </span>
                </label>
              </div>
                ...
                <label className="label cursor-pointer justify-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-base-content/70">
                      Public boards can be accessed by anyone with the URL. Private boards require authentication.
                    </div>
                  </div>
                </label>
              </div>
