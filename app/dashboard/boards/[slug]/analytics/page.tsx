...
export default function BoardAnalyticsPage() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <div className={`badge badge-sm ${statusColors[status as keyof typeof statusColors] || "badge-ghost"}`}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="stats stats-vertical lg:stats-horizontal shadow w-full mb-8">
            ...
            <div className="stat">
              ...
              <div className="stat-value text-secondary">{analytics.total_upvotes}</div>
            ...
            <div className="stat">
              ...
              <div className="stat-value text-info">
                {analytics.total_requests > 0 
                  ? ((analytics.total_upvotes + analytics.total_comments) / analytics.total_requests).toFixed(1)
                  : "0"
                }
              </div>
              ...
              <div className="card-body">
                ...
                <div className="space-y-3">
                  {Object.entries(analytics.status_breakdown).map(([status, count]) => {
                    const percentage = analytics.total_requests > 0 
                ...
                <div className="space-y-2 mt-4">
                  {Object.entries(analytics.status_breakdown).map(([status, count]) => {
                    ...
                    return (
                      <div key={status}>
                        <progress 
                          className={`progress ${progressColors[status as keyof typeof progressColors]} w-full`} 
                          value={percentage} 
                          max="100"
                        ></progress>
                      </div>
              ...
              <div className="card-body">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">{formatDate(analytics.board_info.created_at)}</div>
                  </div>
                  
                  <div>
                    <div className="text-sm text-base-content/70 mb-1">Status</div>
                    <div className="flex items-center gap-2">
                      <div className={`badge ${analytics.board_info.is_public ? "badge-success" : "badge-warning"}`}>
