...
export default function EditBoardPage() {
  ...
  const handleDeleteBoard = async () => {
    if (!window.confirm(`Are you sure you want to delete "${board?.title}"? This action cannot be undone and will delete all feature requests associated with this board.`)) {
      return;
    }
    ...
    try {
      ...
      showMessage("Failed to delete board. Please try again.", "error");
    } finally {
      setIsSaving(false);
    }
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                {/* Danger Zone */}
                <div className="divider text-error">Danger Zone</div>
                <button
