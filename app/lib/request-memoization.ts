 ...
 */
export const memoizedGetServerSession = cache(async (authOptions: any) => {
 ...
 */
export const memoizedFindUpvote = cache(async (featureRequestId: string, userIdentifier: string) => {
